...
如果列表项目的顺序可能会变化，我们不建议使用索引来用作 key 值，因为这样做会**导致性能变差**，还可能引起组件状态的问题。如果你选择不指定显式的 key 值，那么 React 将默认使用索引用作为列表项目的 key 值。[demo1](https://codepen.io/wzh19940000/pen/NOoqQK?editors=0010), [demo2](https://codepen.io/wzh19940000/pen/pxGJXj?editors=0010)。
